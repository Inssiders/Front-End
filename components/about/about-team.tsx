  ...
  const team = [
    {
      ...
      bio: "전 카카오 프로덕트 매니저, 서울대 경영학과 졸업",
      social: {
        linkedin: "#",
        twitter: "#",
        website: "#",
    ...
    },
    {
      ...
      bio: "전 네이버 시니어 개발자, KAIST 전산학과 졸업",
      social: {
        linkedin: "#",
        twitter: "#",
        website: "#",
    ...
    },
    {
      ...
      bio: "전 토스 UX/UI 디자이너, 홍익대 시각디자인과 졸업",
      social: {
        linkedin: "#",
        twitter: "#",
        website: "#",
    ...
    },
    {
      name: "최유진",
      role: "콘텐츠 책임자",
      avatar: "/placeholder.svg?height=100&width=100&text=YJ",
      bio: "전 SM 엔터테인먼트 콘텐츠 PD, 연세대 미디어학과 졸업",
      social: {
        linkedin: "#",
        twitter: "#",
        website: "#",
  ...
  return (
    <div className="py-20 bg-white dark:bg-gray-950">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl font-bold mb-4 text-gray-900 dark:text-white">팀 소개</h2>
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            인싸이더는 다양한 배경과 전문성을 가진 팀원들이 모여 MZ세대를 위한 최고의 플랫폼을 만들어가고 있습니다.
          </p>
        </motion.div>
