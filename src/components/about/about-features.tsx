...
export default function AboutFeatures() {
  const FEATURES = [
    {
      title: "맞춤형 추천 및 알림",
      icon: <Bell className="size-10 text-purple-600" />,
      description:
  ...
  return (
    <div className="bg-gray-50 py-20 dark:bg-gray-900">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="mb-4 text-3xl font-bold text-gray-900 dark:text-white">주요 기능</h2>
          <p className="mx-auto max-w-2xl text-lg text-gray-600 dark:text-gray-400">
            인싸이더는 다양한 소스의 트렌드를 선별·해설하여, 누구보다 빠르고 정확하게 최신 밈과
            문화를 경험할 수 있는 플랫폼입니다.
            <br />
            <span className="font-semibold text-primary">
              최신 밈 트렌드를 제공하고, 정확하게 제공하거나 제공하지 않는 밈을 제공합니다.
            </span>
          </p>
        </motion.div>
