...
export default function AboutMission() {
  const missions = [
    ...
    },
    {
      ...
      title: "커뮤니티 형성",
      description:
        "같은 관심사를 가진 사용자들이 모여 소통하고 공유할 수 있는 활발한 커뮤니티를 만들어갑니다.",
    },
    {
      icon: <Zap className="size-8 text-purple-600" />,
      title: "창작 지원",
      description:
        "크리에이터들이 자신만의 콘텐츠를 제작하고 공유할 수 있는 다양한 도구와 플랫폼을 제공합니다.",
    },
    {
      icon: <Globe className="size-8 text-purple-600" />,
      title: "글로벌 확장",
      description:
  ...
  return (
    <div className="bg-white py-20 dark:bg-gray-950">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="mb-4 text-3xl font-bold text-gray-900 dark:text-white">우리의 미션</h2>
          <p className="mx-auto max-w-2xl text-lg text-gray-600 dark:text-gray-400">
            인싸이더는 MZ세대의 문화와 트렌드를 선도하고, 창의적인 콘텐츠 생태계를 구축하는 것을
            목표로 합니다.
          </p>
        </motion.div>
