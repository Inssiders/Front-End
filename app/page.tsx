...
import DynamicVideoGrid from "@/components/dynamic-video-grid"

// Import ThreeScene component with dynamic import to avoid SSR issues
const ThreeScene = dynamic(() => import("@/components/three-scene"), {
  ssr: false,
  loading: () => <div className="fixed w-[150px] h-[150px] bottom-[50px] left-[50px] bg-mocha-700 rounded-md" />,
})
...
export default function Home(): JSX.Element {
  ...
  const secondSectionOpacity = useTransform(scrollYProgress, [0.2, 0.3, 0.55, 0.65], [0, 1, 1, 0])
  const secondSectionY = useTransform(scrollYProgress, [0.2, 0.3, 0.55, 0.65], [100, 0, 0, -100])
  ...
  return (
    <div ref={containerRef} className="relative h-[300vh]">
      ...
      {/* First Section */}
      <motion.section
        style={{ opacity: firstSectionOpacity, scale: firstSectionScale, y: firstSectionY }}
      ...
      >
        <div className="max-w-4xl text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">Discover a New Experience</h1>
          <p className="text-xl md:text-2xl text-cream-200 max-w-2xl mx-auto">
            Immerse yourself in a world of possibilities. Our platform offers innovative solutions designed to transform
      ...
      >
        <div className="max-w-4xl text-center">
          ...
          <p className="text-xl mb-12 max-w-2xl mx-auto">
            We provide cutting-edge solutions that make your experience seamless and enjoyable.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-cream-200 p-6 rounded-xl transform transition-transform duration-300 hover:scale-105">
              ...
              <p>Experience a seamless interface that makes navigation effortless and enjoyable.</p>
            </div>
            <div className="bg-cream-200 p-6 rounded-xl transform transition-transform duration-300 hover:scale-105">
              <h3 className="text-xl font-semibold mb-3">Smart Solutions</h3>
              <p>Our intelligent tools adapt to your needs, providing personalized recommendations.</p>
            </div>
            <div className="bg-cream-200 p-6 rounded-xl transform transition-transform duration-300 hover:scale-105">
              <h3 className="text-xl font-semibold mb-3">Global Reach</h3>
              <p>Connect with users worldwide and expand your horizons with our platform.</p>
            </div>
            <div className="bg-cream-200 p-6 rounded-xl transform transition-transform duration-300 hover:scale-105">
              <h3 className="text-xl font-semibold mb-3">Secure Platform</h3>
              <p>Rest easy knowing your data is protected with our state-of-the-art security measures.</p>
            </div>
          </div>
        </div>
      </motion.section>
      ...
      >
        <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row gap-8">
          <div className="lg:w-1/4 mb-8 lg:mb-0">
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-center lg:text-left">Meme Gallery</h2>
            <p className="text-lg mb-6">
              Explore our collection of trending memes. Hover over any video to play it and see it in action. Our
              curated selection brings you the best content from across the internet.
            </p>
            <p className="text-lg mb-6">
              Each meme represents a unique moment in internet culture, carefully selected for your entertainment.
            </p>
          </div>
